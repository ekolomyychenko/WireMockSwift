...
final class MatcherIntegrationTests: XCTestCase {
    ...
    func testBinaryEqualTo() async throws {
        ...
        assertMatch(try await TestServer.hit("bin", method: "POST", body: payload))
        assertMiss(try await TestServer.hit("bin", method: "POST", body: Data("goodbye".utf8)))
    }
    ...
    func testEqualToJsonIgnoreArrayOrder() async throws {
        ...
        assertMatch(try await TestServer.hit("aj", method: "POST", headers: jsonHeaders, body: Data(#"{"items":[3,2,1]}"#.utf8)),
                    "reordered array should still match with ignoreArrayOrder")
        assertMiss(try await TestServer.hit("aj", method: "POST", headers: jsonHeaders, body: Data(#"{"items":[1,2]}"#.utf8)),
    ...
    func testEqualToJsonIgnoreExtraElements() async throws {
        ...
        assertMatch(try await TestServer.hit("ee", method: "POST", headers: jsonHeaders, body: Data(#"{"a":1,"b":2}"#.utf8)),
                    "extra key allowed with ignoreExtraElements")
        assertMiss(try await TestServer.hit("ee", method: "POST", headers: jsonHeaders, body: Data(#"{"a":2}"#.utf8)),
    ...
    func testEqualToIgnoreCaseHeader() async throws {
        ...
        assertMatch(try await TestServer.hit("ci", headers: ["X-Env": "prod"]))
        assertMatch(try await TestServer.hit("ci", headers: ["X-Env": "Prod"]))
        assertMiss(try await TestServer.hit("ci", headers: ["X-Env": "staging"]))
    }
    ...
    func testNotMatchingQueryParam() async throws {
        ...
        assertMatch(try await TestServer.hit("nm?q=abc"), "non-numeric passes doesNotMatch")
        assertMiss(try await TestServer.hit("nm?q=123"), "numeric fails doesNotMatch")
    }
    ...
    func testNotContainingQueryParam() async throws {
        ...
        assertMatch(try await TestServer.hit("nc?q=good"))
        assertMiss(try await TestServer.hit("nc?q=verybad"))
    }
    ...
    func testAbsentHeader() async throws {
        ...
        assertMatch(try await TestServer.hit("ab"), "no header -> matches absent")
        assertMiss(try await TestServer.hit("ab", headers: ["X-Trace": "1"]), "present header must fail absent")
    }
    ...
    func testMatchingJsonSchema() async throws {
        ...
        assertMatch(try await TestServer.hit("js", method: "POST", headers: jsonHeaders, body: Data(#"{"name":"bob"}"#.utf8)))
        assertMiss(try await TestServer.hit("js", method: "POST", headers: jsonHeaders, body: Data(#"{"name":5}"#.utf8)),
                   "wrong type violates schema")
        assertMiss(try await TestServer.hit("js", method: "POST", headers: jsonHeaders, body: Data(#"{}"#.utf8)),
    ...
    func testEqualToXmlWithPlaceholders() async throws {
        ...
        assertMatch(try await TestServer.hit("xp", method: "POST", headers: xmlHeaders, body: Data("<msg><id>anything</id></msg>".utf8)),
                    "placeholder ignores the id value")
        assertMiss(try await TestServer.hit("xp", method: "POST", headers: xmlHeaders, body: Data("<msg><name>x</name></msg>".utf8)),
    ...
    func testMatchingXPathWithNamespaces() async throws {
        ...
        let matched = try await TestServer.hit("xn", method: "POST", headers: xmlHeaders,
            body: Data(#"<t:note xmlns:t="urn:test"><t:to>Bob</t:to></t:note>"#.utf8))
        assertMatch(matched)
        let missed = try await TestServer.hit("xn", method: "POST", headers: xmlHeaders,
    ...
    func testDateTimeMatchers() async throws {
        ...
        assertMatch(try await TestServer.hit("before?d=2020-06-01T00:00:00Z"))
        assertMiss(try await TestServer.hit("before?d=2040-06-01T00:00:00Z"))

        try await wireMock.stubFor(
            get(urlPathEqualTo("/after")).withQueryParam("d", after("2020-01-01T00:00:00Z")).willReturn(ok())
        )
        assertMatch(try await TestServer.hit("after?d=2025-06-01T00:00:00Z"))
        assertMiss(try await TestServer.hit("after?d=2010-06-01T00:00:00Z"))

        try await wireMock.stubFor(
            get(urlPathEqualTo("/eq")).withQueryParam("d", equalToDateTime("2020-01-01T00:00:00Z")).willReturn(ok())
        )
        assertMatch(try await TestServer.hit("eq?d=2020-01-01T00:00:00Z"))
        assertMiss(try await TestServer.hit("eq?d=2020-01-02T00:00:00Z"))
    }
    ...
    func testAndCombinator() async throws {
        ...
        assertMatch(try await TestServer.hit("and?q=foobaz"))
        assertMiss(try await TestServer.hit("and?q=foobar"), "contains bar -> fails AND")
        assertMiss(try await TestServer.hit("and?q=baz"), "missing foo -> fails AND")
    }
    ...
    func testOrCombinator() async throws {
        ...
        assertMatch(try await TestServer.hit("or?q=red"))
        assertMatch(try await TestServer.hit("or?q=blue"))
        assertMiss(try await TestServer.hit("or?q=green"))
    }
    ...
    func testNotCombinator() async throws {
        ...
        assertMatch(try await TestServer.hit("not?q=public"))
        assertMiss(try await TestServer.hit("not?q=secret"))
    }
    ...
    func testHasExactlyWrongCount() async throws {
        ...
        assertMatch(try await TestServer.hit("he?id=1&id=2"))
        assertMiss(try await TestServer.hit("he?id=1&id=2&id=3"), "3 values != exactly 2")
        assertMiss(try await TestServer.hit("he?id=1"), "1 value != exactly 2")
    }
    ...
    func testUrlPathTemplateWithPathParam() async throws {
        ...
        assertMatch(try await TestServer.hit("things/42"))
        assertMiss(try await TestServer.hit("things/abc"), "non-numeric path param must not match")
    }
    ...
    func testFormParameters() async throws {
        ...
        assertMatch(try await TestServer.hit("form", method: "POST", headers: formHeaders, body: Data("name=bob&age=3".utf8)))
        assertMiss(try await TestServer.hit("form", method: "POST", headers: formHeaders, body: Data("name=alice".utf8)))
    }
    ...
    func testHostPortSchemeMatching() async throws {
        ...
        let port = TestServer.baseURL.port ?? 8080
        try await wireMock.stubFor(
        ...
        assertMatch(try await TestServer.hit("hp"))
        ...
        assertMiss(try await TestServer.hit("hp"), "wrong port must not match")
    }
    ...
    func testMultipartMatchingTypeAllVsAny() async throws {
        ...
        assertMatch(try await TestServer.hit("all", method: "POST", headers: headers, body: twoParts("target a", "target b")),
                    "ALL matches when every part contains target")
        assertMiss(try await TestServer.hit("all", method: "POST", headers: headers, body: twoParts("target a", "other b")),
        ...
        assertMatch(try await TestServer.hit("any", method: "POST", headers: headers, body: twoParts("target a", "other b")),
                    "ANY matches when at least one part contains target")
        assertMiss(try await TestServer.hit("any", method: "POST", headers: headers, body: twoParts("other a", "other b")),
